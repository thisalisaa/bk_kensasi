...
use App\Models\DataSiswa; // Menggunakan model DataSiswa yang sesuai
...
{
    $request->validate([
        //'foto_siswa' => 'image|mimes:jpeg,jpg,png,gif|max:2048', // Validasi untuk bidang foto
        'nisn' => 'required',
        'nama' => 'required',
        'kelas' => 'required',
        'jk' => 'required',
    ...
    public function update(Request $request, DataSiswa $datasiswa)
    {
        ...
        return redirect()->route('datasiswa.index')
                        ->with('success', 'Data siswa updated successfully');
    }
    ...
    public function destroy(DataSiswa $datasiswa)
    {
        ...
        return redirect()->route('datasiswa.index')
                        ->with('success', 'Data siswa deleted successfully');
    }
}
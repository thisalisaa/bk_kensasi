...
<body>
    ...
    <nav class="navbar navbar-expand-md bg-primary shadow-sm navbar-primary">
        ...
        <img src="{{ asset('assets/image/logokensasi-removebg-preview.png') }}" alt="Logo Informasi Pemagangan" class="logo-informasi">
            <div>
                <b class="informasi-pemagangan">Bimbingan Konseling</b>
...
<footer class="bg-primary text-light text-center py-3">
    <div class="container-fluid">
        <div class="row">
            ...
            <img src="{{ asset('assets/image/logokensasi-removebg-preview.png') }}" alt="Logo Informasi Pemagangan" class="logo-informasi">
                ...
                <p style=" font-size: 15px; text-align: justify;">Platform BK Sekolah ini didedikasikan untuk Layanan Bimbingan dan Konseling di SMKN 1 Sindang. Platform ini menyediakan banyak fitur yang akan menjadi alat bantu Konselor Sekolah/Guru Bimbingan dan Konseling</p>
            </div>
    ...
    <p class="mb-0" style="font-size: 10px;">copyright &copy; 2023 BK SMKN 1 SINDANG.</p>
</footer>
</html>
